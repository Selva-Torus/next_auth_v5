...
// // // AssemblerJson.menuGroup.map((menuGro, index) =>
// // //   console.log(Object.keys(menuGro))
// // // );

// // function getKeys(obj) {
// //   if (typeof obj == "object" && Array.isArray(obj)) {
// //     // Array
// //     obj.map((key) => getKeys(obj[key]));
// //   }

// //   if (typeof obj == "object" && !Array.isArray(obj)) {
// //     // object
// //     Object.keys(obj).map((key) => getKeys(obj[key]));
// //   }
// // }

// // // getKeys(AssemblerJson.menuGroup);

// // // console.log(typeof AssemblerJson.Tenant); //string

// // // console.log(typeof AssemblerJson && Array.isArray(AssemblerJson)); //object

// // // console.log(typeof AssemblerJson.roles && Array.isArray(AssemblerJson.roles)); //

// // // {
// // //   AssemblerJson.menuGroup.map((menuGro, index) =>
// // //     Object.keys(menuGro).map((menuGroup, i) =>
// // //       Object.keys(menuGro[`${menuGroup}`]).map((menuItems, j) =>
// // //         Object.keys(menuGro[`${menuGroup}`][`${menuItems}`]).map((model, i) =>
// // //           Object.keys(menuGro[`${menuGroup}`][`${menuItems}`][`${model}`]).map(
// // //             (fabric, i) => console.log(fabric)
// // //           )
// // //         )
// // //       )
// // //     )
...
// // // console.log(Object.keys(AssemblerJson));

// // // console.log(Object.keys(AssemblerJson.menuGroup[0]));

// // // console.log(Object.keys(AssemblerJson.menuGroup[0].mg1[0].mi1));

// // // console.log(Object.keys(AssemblerJson.menuGroup[0].mg1[0].mi1.df));
...
// // var main = [];
// // // for (let i; i < AssemblerJson.menuGroup.length; i++) {
// // //   var menuItem;
// // //   var fabric, key, version, roles;
// // // }
// // // const menuGroup = [
// // //   {
// // //     mg1: [
...
// // // // const data=[{menuGroup:mg1, menuItem:mi1,fabric:{name:df,keys:modelkey,version:version,roles:roles}},{menuGroup:mg1, menuItem:mi1,fabric:{name:df,keys:modelkey,version:version,roles:roles}}, {menuGroup:mg1, menuItem:mi1,fabric:{name:df,keys:modelkey,version:version,roles:roles}}]

// // // const data = menuGroup.flatMap((group) => {
// // //   return Object.entries(group).map(([key, value]) => {
// // //     const menuItem = value[0];
// // //     return {
// // //       menuitem: Object.keys(menuItem)[0],
// // //       fabric: Object.entries(menuItem).flatMap(([fabricName, fabricValue]) => {
// // //         return Object.entries(fabricValue).map(([prop, propValue]) => {
// // //           return {
// // //             name: fabricName,
// // //             keys: propValue.modelkey,
// // //             version: propValue.version,
// // //             roles: propValue.roles,
// // //           };
// // //         });
// // //       }),
// // //     };
...
// // // const data = menuGroup.flatMap((group) => {
// // //   return Object.entries(group).flatMap(([menuGroupKey, menuItems]) => {
// // //     return menuItems.map((menuItem) => {
// // //       const menuItemKey = Object.keys(menuItem)[0];
// // //       const fabrics = Object.entries(menuItem[menuItemKey]).map(
// // //         ([fabricName, fabricValue]) => {
// // //           return {
// // //             name: fabricName,
// // //             keys: fabricValue.modelkey,
// // //             version: fabricValue.version,
// // //             roles: fabricValue.roles,
// // //           };
// // //         }
// // //       );
// // //       return {
...
// //   var menuItem = [];
// //   var fabric, key, version, roles;
// //   menuGro = Object.keys(menuGroup[i]); //[mg1, mg2]
// //   // console.log(menuGro);
// //   for (let j = 0; j < menuGro.length; j++) {
// //     main
// //     menuGroup[i][menuGro[j]].map((ele, id) => {
// //       var model = Object.keys(ele);
// //       for (let k = 0; k < model.length; k++) {
// //         var fabric = Object.keys(ele[model[k]]);
// //         var setFabric = {};
...
// // // console.log(main[0].menuItem);
// // // console.log(main[0].menuItem[1]);
// // const menuGroup = [
// //   {
// //     mg1: [
// //       {
...
// //     const menuItems = group[groupKey].map((item) => {
// //       const itemName = Object.keys(item)[0];
// //       const fabric = [];
// //       Object.keys(item[itemName]).forEach((fabricName) => {
// //         fabric.push({
// //           name: fabricName,
// //           modelkey: item[itemName][fabricName].modelkey,
// //           version: item[itemName][fabricName].version,
// //           roles: item[itemName][fabricName].roles,
// //         });
// //       });
// //       return { item: itemName, Fabric: fabric };
// //     });
// //     data.push({ menuGroup: groupKey, menuItems: menuItems });
// //   });
// // });

// // // console.log(data[0].menuItems[0].Fabric);
...
//         {
//           mi1: {
//             df: { modelkey: "", version: "", roles: "" },
//             uf: { modelkey: "", version: "", roles: "" },
//             pf: { modelkey: "", version: "", roles: "" },
//             miroles: [],
//           },
//           mi2: {
//             df: { modelkey: "", version: "", roles: "" },
...
//           return {
//             item: itemName,
//             Fabric: Object.entries(fabric).map(([fabricName, properties]) => {
...
// const convertedData = convertData(AssemblerJson);
